      ...
      <ul className="m-0">
        <li className="d-flex align-center mt-15">
          ...
          <div className="pl-15 blue">
            ...
            <span className="fs-13 c-grey">28/01/2024 - 12:00am</span>
          </div>
        </li>
        <li className="d-flex align-center mt-15">
          ...
          <div className="pl-15 green">
            ...
            <span className="fs-13 c-grey">31/1/2024 - 12:00am</span>
          </div>
        </li>
        <li className="d-flex align-center mt-15">
          ...
          <div className="pl-15 orange">
            ...
            <span className="fs-13 c-grey">05/3/2024 - 13:00pm</span>
          </div>
        </li>
        <li className="d-flex align-center mt-15">
          ...
          <div className="pl-15 red">
            ...
            <span className="fs-13 c-grey">20/3/2024 - 11:00am</span>
          </div>
        </li>
      </ul>
    </div>
