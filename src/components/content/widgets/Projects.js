        ...
        >
          ...
          {searchValue ? (
            ...
            {allProjects.map((project, index) => {
              if (
                project.props.title
                  .toLowerCase().replace(/g*s" "/, "")
                  .includes(searchValue.toLowerCase().replace(/g*s" "/, ""))
              ) {
                return (
                  <React.Fragment key={index}>
                    <ProjectCard
                      date={project.props.date}
                      title={project.props.title}
                      desc={project.props.desc}
                      src={project.props.src}
                      skills={project.props.skills}
                      lvl={project.props.lvl}
                      price={project.props.price}
                    />
                  </React.Fragment>
                );
              }
